    ...
    <div className="absolute top-0 left-1/2 -translate-x-1/2 z-20 w-full max-w-[520px] px-4 pt-3 animate-fade-in-up">
      <div
        className={`
          ...
          border rounded-xl shadow-none
          transition-all duration-300 ease-out
          ${isFocused
            ? 'bg-black/65 border-[#C9A84C]/40'
      ...
      >
        ...
        <input
          ...
          className="w-full py-3 pl-11 pr-12 text-[13px] text-white placeholder-white/30 bg-transparent focus:outline-none tracking-wide"
        />
        <div className="absolute right-3 top-1/2 -translate-y-1/2 flex items-center space-x-1.5">
          <kbd className="hidden sm:inline-flex items-center px-1.5 py-0.5 text-[9px] text-white/25 bg-white/5 border border-white/10 rounded font-mono">⌘K</kbd>
        </div>
      </div>
    </div>
  );
