...
import type { Tier, EarlyProgress } from './page'
...
const ABOUT_STYLES = `
  ...
  .ss-about-section::before {
    content: '';
    position: absolute; top: -20%; right: -10%; width: 55%; height: 80%;
  ...
  .ss-about-founder-tag {
    ...
    font-family: var(--font-dm-sans), sans-serif;
    font-size: 12px; font-weight: 500; color: #C9A875;
  ...
  .ss-about-ghost-link {
    ...
    color: rgba(245,241,234,0.55); text-decoration: none;
    display: inline-flex; align-items: center; gap: 6px;
    transition: color 200ms ease;
  }
  .ss-about-ghost-link:hover { color: #C9A875; }
  ...
  @media (prefers-reduced-motion: reduce) {
    .ss-about-stat, .ss-about-line-inner, .ss-about-body,
    .ss-about-cta-area, .ss-about-founder-tag {
...
export default function SupportPageClient({ tiers, initialProgress }: Props) {
  ...
  return (
    <div style={{ background: '#0A0908', minHeight: '100vh' }}>
      ...
      <main>
        ...
        <section
          style={{
            position: 'relative', minHeight: '100vh', background: '#0A0908',
        ...
        >
          ...
          >
            ...
            <div style={{
              ...
              backgroundImage: 'url(https://images.unsplash.com/photo-1582719508461-905c673771fd?w=1800&q=80)',
          ...
          <div style={{
            ...
            alignItems: 'center', gap: 'clamp(32px,4vw,48px)', width: '100%', maxWidth: 680, textAlign: 'center',
          }}>
            <p className="ss-hero-item" style={{ animationDelay: '0ms', fontFamily: 'var(--font-dm-sans), sans-serif', fontSize: 11, fontWeight: 500, textTransform: 'uppercase', letterSpacing: '0.18em', color: '#C9A875', margin: 0 }}>
            ...
            <div className="ss-hero-item" style={{ animationDelay: '550ms', width: 'min(680px,92vw)', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
              ...
              <p style={{ fontFamily: 'var(--font-dm-sans), sans-serif', fontSize: 11, fontWeight: 500, textTransform: 'uppercase', letterSpacing: '0.1em', color: '#C9A875', textAlign: 'center', margin: '12px 0 0' }}>
                {pledgedPct}% funded
              </p>
            </div>
          </div>
        ...
        <section
          ...
          style={{ background: '#0A0908', padding: 'clamp(80px,12vw,160px) 24px' }}
        >
          {/* eslint-disable-next-line react/no-danger */}
          ...
          <div style={{ maxWidth: 'min(680px,92vw)', margin: '0 auto' }}>
            ...
            <h2 className="ss-story-child" style={{ animationDelay: '100ms', fontFamily: 'var(--font-cormorant), var(--font-playfair), Georgia, serif', fontSize: 'clamp(1.75rem,4.5vw,3rem)', fontWeight: 400, lineHeight: 1.2, letterSpacing: '-0.01em', color: '#F5F1EA', margin: '16px 0 0' }}>
            ...
            <div className="ss-story-child" style={{ animationDelay: '400ms' }}>
              ...
              <p style={{ fontFamily: 'var(--font-dm-sans), sans-serif', fontSize: 'clamp(16px,1.8vw,18px)', fontWeight: 400, lineHeight: 1.75, color: 'rgba(245,241,234,0.82)', margin: '28px 0 0' }}>
                ...
                <em style={{ fontFamily: 'var(--font-cormorant), var(--font-playfair), Georgia, serif', fontStyle: 'italic', fontWeight: 400 }}>you</em>
            ...
            <div className="ss-story-child" style={{ animationDelay: '550ms', marginTop: 24 }}>
              <div style={{ display: 'flex', gap: 24, alignItems: 'stretch' }}>
                ...
                <p style={{ fontFamily: 'var(--font-cormorant), var(--font-playfair), Georgia, serif', fontSize: 'clamp(1.5rem,3.5vw,2.25rem)', fontStyle: 'italic', fontWeight: 400, lineHeight: 1.3, color: '#C9A875', margin: 0 }}>
        ...
        <section
          ...
          style={{ background: '#0A0908', padding: 'clamp(80px,10vw,140px) 24px' }}
        >
          {/* eslint-disable-next-line react/no-danger */}
          ...
          <div style={{ maxWidth: 'min(1200px,92vw)', margin: '0 auto' }}>
            <div style={{ textAlign: 'center', marginBottom: 64 }}>
              ...
              <p style={{ fontFamily: 'var(--font-dm-sans), sans-serif', fontSize: 'clamp(15px,1.7vw,17px)', color: '#A89B8C', lineHeight: 1.6, maxWidth: 520, margin: '24px auto 0' }}>
                Every tier includes lifetime access. Limited tiers are gone when they&apos;re gone.
              </p>
            </div>

            {tiers.length === 0 ? (
              <p style={{ textAlign: 'center', color: 'rgba(245,241,234,0.4)', fontFamily: 'var(--font-dm-sans), sans-serif', fontSize: 15 }}>
                Tiers loading…
              </p>
            ) : (
              <div className="ss-tiers-grid">
                {tiers.map((tier) => (
                  <div
                    ...
                    style={{ position: 'relative', background: '#14100D', border: '1px solid rgba(201,168,117,0.18)', borderRadius: 12, padding: 32, display: 'flex', flexDirection: 'column', gap: 20 }}
                  >
                    {tier.slug === 'wanderer' && (
                      <span style={{ position: 'absolute', top: -10, left: '50%', transform: 'translateX(-50%)', padding: '4px 14px', background: '#C9A875', color: '#14100D', borderRadius: 999, fontFamily: 'var(--font-dm-sans), sans-serif', fontSize: 10, fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.14em', whiteSpace: 'nowrap' }}>
                        MOST POPULAR
                      </span>
                    )}
                    ...
                    <p style={{ fontFamily: 'var(--font-cormorant), var(--font-playfair), Georgia, serif', fontSize: 'clamp(2.5rem,3.5vw,3.25rem)', fontWeight: 400, lineHeight: 1, color: '#F5F1EA', margin: 0 }}>
                    ...
                    {/* ✅ Each button uses tier.stripe_payment_link — unique per tier from Supabase */}
                    <a
                      ...
                      style={{
                        ...
                        background: '#C9A875', color: '#14100D', borderRadius: 999,
            ...
            <p style={{ fontFamily: 'var(--font-dm-sans), sans-serif', fontSize: 13, color: '#A89B8C', textAlign: 'center', marginTop: 56 }}>
        ...
        >
          ...
          <div
            className="ss-about-grid"
            style={{
              position: 'relative', zIndex: 1,
              maxWidth: 'min(1200px,92vw)', margin: '0 auto',
          ...
          >
            <div className="ss-about-sticky" style={{ position: 'sticky', top: 120 }}>
              ...
              <motion.div
                ...
                style={{ width: 40, height: 1, background: 'rgba(201,168,117,0.5)', marginTop: 32, transformOrigin: 'left center' }}
              />
            </div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 28 }}>
              ...
              <p className="ss-about-body" style={{ fontFamily: 'var(--font-dm-sans), sans-serif', fontSize: 'clamp(16px,1.6vw,18px)', fontWeight: 400, lineHeight: 1.8, color: 'rgba(245,241,234,0.75)' }}>
                ...
                <em style={{ fontFamily: 'var(--font-cormorant), var(--font-playfair), Georgia, serif', fontStyle: 'italic', fontSize: 'clamp(17px,1.7vw,19px)', color: 'rgba(245,241,234,0.88)' }}>A companion.</em>
              </p>
              <p className="ss-about-body" style={{ fontFamily: 'var(--font-dm-sans), sans-serif', fontSize: 'clamp(16px,1.6vw,18px)', fontWeight: 400, lineHeight: 1.8, color: 'rgba(245,241,234,0.75)' }}>
              ...
              <div className="ss-about-cta-area" style={{ display: 'flex', alignItems: 'center', gap: 20, marginTop: 12, flexWrap: 'wrap' }}>
                <a
                  ...
                  style={{ display: 'inline-flex', alignItems: 'center', height: 48, padding: '0 32px', borderRadius: 999, fontSize: 14, fontWeight: 500, fontFamily: 'var(--font-dm-sans), sans-serif', letterSpacing: '0.03em', textDecoration: 'none', color: '#14100D' }}
                >
                  Back the project
                </a>
                <span style={{ fontFamily: 'var(--font-dm-sans), sans-serif', fontSize: 13, color: 'rgba(245,241,234,0.35)', letterSpacing: '0.02em' }}>
